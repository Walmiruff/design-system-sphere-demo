...
const DATA_SOURCE: Array<DataSourceInterface> = [
  { name: 'Optimus Prime', cpf: '778.769.370-39', code: null, age: 33, nationality: 'Cybertron' },
  ...
  { name: 'Starscream', cpf: '558.375.100-28', code: null, age: 33, nationality: 'Cybertron' },
  ...
  { name: 'Frenzy', cpf: '786.856.100-95', code: null, age: 33, nationality: 'Cybertron' },
